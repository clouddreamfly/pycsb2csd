...
class TextBMFontOptions(object):
    ...
    @classmethod
    def GetRootAsTextBMFontOptions(cls, buf, offset=0):
...
def TextBMFontOptionsStart(builder):
...
def TextBMFontOptionsAddWidgetOptions(builder, widgetOptions):
...
def TextBMFontOptionsAddFileNameData(builder, fileNameData):
...
def TextBMFontOptionsAddText(builder, text):
    """This method is deprecated. Please switch to AddText."""
    return AddText(builder, text)
def AddIsLocalized(builder, isLocalized): builder.PrependBoolSlot(3, isLocalized, 0)
def TextBMFontOptionsAddIsLocalized(builder, isLocalized):
    """This method is deprecated. Please switch to AddIsLocalized."""
    return AddIsLocalized(builder, isLocalized)
def End(builder): return builder.EndObject()
def TextBMFontOptionsEnd(builder):

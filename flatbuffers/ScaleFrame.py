...
class ScaleFrame(object):
    ...
    @classmethod
    def GetRootAsScaleFrame(cls, buf, offset=0):
...
def ScaleFrameAddTween(builder, tween):
    """This method is deprecated. Please switch to AddTween."""
    return AddTween(builder, tween)
def AddScale(builder, scale): builder.PrependStructSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(scale), 0)
def ScaleFrameAddScale(builder, scale):

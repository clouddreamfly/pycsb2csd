...
class GameMapOptions(object):
    ...
    @classmethod
    def GetRootAsGameMapOptions(cls, buf, offset=0):
...
def GameMapOptionsStart(builder):
...
def GameMapOptionsAddNodeOptions(builder, nodeOptions):

...
class EventFrame(object):
    ...
    @classmethod
    def GetRootAsEventFrame(cls, buf, offset=0):
...
def EventFrameAddTween(builder, tween):
...
def EventFrameAddValue(builder, value):
